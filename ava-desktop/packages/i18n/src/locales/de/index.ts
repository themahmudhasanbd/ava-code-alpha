...
export const de = {
  "app": {
    ...
    "starting": "AvA Code wird gestartet…",
    "loadingView": "Ansicht wird geladen…",
    "uiCrashed": "Mit der Schnittstelle ist ein Fehler aufgetreten"
  },
  "startup": {
    "slowTitle": "Startet noch…",
    "slowBody": "AvA Code braucht länger als sonst, um Ihren lokalen Dienst zu erreichen. Der Start kann noch von selbst abschließen — Sie können warten oder zuerst die Protokolle sichern.",
    "stalledTitle": "AvA Code konnte den Start nicht abschließen",
  ...
  "tray": {
    ...
    "open": "Öffnen Sie AvA Code",
    "quit": "Beenden Sie AvA Code",
    "askTitle": "Lassen Sie AvA Code im Hintergrund laufen?",
    "askBody": "Wenn Sie das Fenster schließen, kann AvA Code in der Taskleiste weiterlaufen, sodass nichts verloren geht. Sie können dies jederzeit in den Einstellungen ändern.",
    "closeToTray": "In der Taskleiste",
    "confirmQuitTitle": "AvA Code beenden?",
  ...
  "chat": {
    ...
    "placeholder": "Bitten Sie AvA Code um Hilfe bei allem",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Wird in AvA Code gespeichert und von der Laufzeitumgebung verwendet. Das Plugin erhält ihn niemals.",
  ...
  "scheduled": {
    "description": "Wiederkehrende Agent-Aufgaben ausführen, solange AvA Code geöffnet ist.",
    ...
    "time": "Uhrzeit",
    "weekday": "Wochentag",
    "localTimeHint": "Verwendet die lokale Zeitzone. AvA Code muss geöffnet bleiben; verpasste Ausführungen werden übersprungen. Eingeschränkte Aktionen erfordern eine Genehmigung.",
...
"importConfirm": "Importierte Erweiterungen laufen im Agentenprozess mit denselben Rechten wie die Tools des Agenten. Deklarierte Skills können dem Agenten Anweisungen hinzufügen, und deklarierte Abhängigkeiten werden mit npm installiert (Installationsskripte deaktiviert). Fortfahren?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Fügt die Anbieter, die dieses Plugin definiert, zur Anbieterliste in den Einstellungen hinzu. Das Plugin liefert den Endpunkt und die Modelle; Ihr API-Schlüssel bleibt in AvA Code.",
      "desktop.control": "Erlaubt den Aufruf des geprüften AvA Code-Katalogs; destruktive Vorgänge benötigen weiterhin confirm=true, und das MCP-Bearer-Token wird nicht offengelegt.",
      ...
      "keyboard.globalShortcut": "Registriert systemweite Tastaturkürzel, die die eigenen Befehle dieses Plugins auslösen, während AvA Code nicht fokussiert ist.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Diese AvA Code-Version ist älter als Ihre lokalen Daten (Datenschema {{found}}, diese Version unterstützt {{supported}}). Installieren Sie die neuere AvA Code-Version, die diese Daten zuletzt geöffnet hat, oder eine spätere.",
    "archMismatch":
