      ...
      <div className="sidebar-header">
        ...
        >
          ...
          <span style={{ display: "inline-flex", alignItems: "center", gap: "6px" }}>
            ...
            <span style={{ fontSize: "9px", fontWeight: 700, letterSpacing: "0.08em", padding: "1px 5px", borderRadius: "4px", background: "rgba(139, 92, 246, 0.18)", color: "#a855f7", border: "1px solid rgba(139, 92, 246, 0.35)", lineHeight: "1.2" }}>
              ALPHA
            </span>
          </span>
        </TooltipButton>
