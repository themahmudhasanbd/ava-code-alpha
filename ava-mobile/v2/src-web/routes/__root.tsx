...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AvA Code" },
      { name: "description", content: "AI coding workspace" },
      { name: "author", content: "AvA Code" },
      { property: "og:title", content: "AvA Code" },
      { property: "og:description", content: "AI coding workspace" },
