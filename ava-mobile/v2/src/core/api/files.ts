...
export async function writeTextFile(rpc: RpcClient, path: string, content: string): Promise<void> {
  await rpc.call("fs/writeFile", { path, dataBase64: encodeBase64(content) });
}
