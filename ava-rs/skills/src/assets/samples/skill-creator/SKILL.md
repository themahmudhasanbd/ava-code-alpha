...
```bash
scripts/init_skill.py my-skill --path "${AVA_CODE_HOME:-$HOME/.ava-code}/skills"
scripts/init_skill.py my-skill --path "${AVA_CODE_HOME:-$HOME/.ava-code}/skills" --resources references
```
