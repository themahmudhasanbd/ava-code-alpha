...
- Installs into `${AVA_CODE_HOME:-$HOME/.ava-code}/skills/<skill-name>` (defaults to `~/.ava-code/skills`).
...
- Installed annotations come from `${AVA_CODE_HOME:-$HOME/.ava-code}/skills`.
