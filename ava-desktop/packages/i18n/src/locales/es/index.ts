...
export const es = {
  "app": {
    ...
    "starting": "Iniciando AvA Code…",
    "loadingView": "Cargando vista…",
    "uiCrashed": "Algo salió mal con la interfaz"
  },
  "startup": {
    "slowTitle": "Aún iniciando…",
    "slowBody": "AvA Code está tardando más de lo habitual en alcanzar tu servicio local. Puede que aún termine por sí solo — puedes esperar o recoger los registros primero.",
    "stalledTitle": "AvA Code no pudo terminar de iniciarse",
  ...
  "tray": {
    ...
    "viewMore": "Ver más…",
    "open": "Abrir AvA Code",
    "quit": "Salir de AvA Code",
    "askTitle": "¿Mantener AvA Code ejecutándose en segundo plano?",
    "askBody": "Cuando cierra la ventana, AvA Code puede seguir ejecutándose en la bandeja del sistema para que no se pierda nada. Puedes cambiar esto en cualquier momento en Configuración.",
    "closeToTray": "Cerca de la bandeja",
    "confirmQuitTitle": "¿Salir de AvA Code?",
  ...
  "chat": {
    ...
    "placeholder": "Pídale ayuda a AvA Code con cualquier cosa",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Se guarda en AvA Code y lo usa el entorno de ejecución. El complemento nunca lo recibe.",
  ...
  "scheduled": {
    "description": "Ejecuta tareas recurrentes mientras AvA Code está abierto.",
    "edit": "Editar tarea",
    ...
    "localTimeHint": "Usa la zona horaria local. Mantén AvA Code abierto; las ejecuciones omitidas no se recuperan. Las acciones restringidas requieren autorización.",
...
"importConfirm": "Las extensiones importadas se ejecutan en el proceso del agente con el mismo acceso que sus propias herramientas. Las habilidades declaradas pueden añadir instrucciones al agente y las dependencias declaradas se instalan con npm (scripts de instalación desactivados). ¿Continuar?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Agregue los proveedores que define este complemento a la lista de proveedores de Configuración. El complemento aporta el punto final y los modelos; su clave API permanece en AvA Code.",
      "desktop.control": "Permite invocar el catálogo de control de AvA Code revisado; las operaciones destructivas siguen requiriendo confirm=true y el token bearer de MCP no se expone.",
      ...
      "keyboard.globalShortcut": "Registra atajos de teclado del sistema que activan los comandos propios de este complemento mientras AvA Code no tiene el foco.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Esta versión de AvA Code es más antigua que tus datos locales (esquema de datos {{found}}, esta versión admite {{supported}}). Instala la versión más reciente de AvA Code que abrió estos datos por última vez, o una posterior.",
    "archMismatch":
