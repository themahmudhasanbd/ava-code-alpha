...
const CONTROL_OPERATION_SPECS: OperationSpec[] = [
  spec("appGetVersion", "app/getVersion", "Return AvA Code Alpha and host versions.", "read", []),
...
const CORE_TOOL_SPECS = [
  coreTool("pi_app_info", "Read AvA Code Alpha and host version information.", objectSchema({}), "app/getVersion", () => []),
...
export class McpControlServer {
  ...
  private buildTools(): McpTool[] {
    ...
    const generic: McpTool = {
      ...
      description: "Invoke a reviewed AvA Code operation. Use pi_control_describe for ids and argument shapes. Dangerous operations require confirm=true. This is an agent acknowledgement, not a user prompt.",
    ...
    const describe: McpTool = {
      ...
      description: "Return the reviewed AvA Code operation catalog.",
      inputSchema: objectSchema({}),
