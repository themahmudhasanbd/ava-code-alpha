...
export const tr = {
  app: {
    ...
    starting: "AvA Code başlatılıyor…",
    loadingView: "Görünüm yükleniyor…",
    uiCrashed: "Arayüzde bir sorun oluştu",
  },
  startup: {
    slowTitle: "Hâlâ başlatılıyor…",
    slowBody: "AvA Code yerel servise ulaşmakta normalden uzun sürüyor. Kendiliğinden tamamlanabilir — bekleyebilir ya da önce günlükleri toplayabilirsiniz.",
    stalledTitle: "AvA Code başlatmayı tamamlayamadı",
  ...
  tray: {
    ...
    open: "AvA Code’u aç",
    quit: "AvA Code’tan çık",
    askTitle: "AvA Code arka planda çalışmaya devam etsin mi?",
    askBody:
      "Pencereyi kapattığınızda AvA Code sistem tepsisinde çalışmaya devam edebilir; hiçbir şey kaybolmaz. Bunu Ayarlar’dan dilediğiniz zaman değiştirebilirsiniz.",
    closeToTray: "Tepsiye kapat",
    confirmQuitTitle: "AvA Code'tan çıkılsın mı?",
    confirmQuitBody:
  ...
  chat: {
    ...
    placeholder: "AvA Code’tan herhangi bir konuda yardım isteyin",
...
sklm: {
    ...
    pluginProviderKeyHint: "AvA Code’ta saklanır ve çalışma zamanı tarafından kullanılır. Eklenti bu anahtarı asla almaz.",
  ...
  scheduled: {
    description: "AvA Code açıkken yinelenen ajan görevlerini çalıştırın.",
    edit: "Görevi düzenle",
    ...
    localTimeHint: "Yerel saat dilimini kullanır. AvA Code açık kalmalıdır; kaçırılan çalıştırmalar atlanır. Kısıtlı işlemler izin gerektirir.",
...
importConfirm: "İçe aktarılan uzantılar ajan sürecinde, ajanın kendi araçlarıyla aynı erişimle çalışır. Bildirilen beceriler ajana talimatlar ekleyebilir ve bildirilen bağımlılıklar npm ile yüklenir (yükleme betikleri devre dışı). Devam edilsin mi?",
    ...
    permissionHelp: {
      ...
      "provider.register":
        "Bu eklentinin tanımladığı servisleri Ayarlar’daki servis listesine ekler. Uç noktayı ve modelleri eklenti sağlar; API anahtarınız AvA Code’ta kalır.",
      "desktop.control":
        "Eklentinin incelenmiş AvA Code denetim kataloğunu çağırmasını sağlar. Yıkıcı işlemler yine confirm=true gerektirir; MCP bearer token eklentiye verilmez.",
      ...
      "keyboard.globalShortcut": "AvA Code odakta değilken bu eklentinin kendi komutlarını tetikleyen sistem geneli klavye kısayollarını kaydeder.",
  ...
  status: {
    ...
    dbSchemaTooNew:
      "Bu AvA Code sürümü yerel verilerinizden daha eski (veri şeması {{found}}, bu sürüm {{supported}} destekliyor). Bu verileri en son açan daha yeni AvA Code sürümünü veya sonrasını yükleyin.",
    archMismatch:
