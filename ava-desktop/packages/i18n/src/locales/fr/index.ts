...
export const fr = {
  "app": {
    ...
    "starting": "Démarrage de AvA Code…",
  ...
  "startup": {
    ...
    "slowBody": "AvA Code met plus de temps que d'habitude à joindre votre service local. Le démarrage peut encore aboutir de lui-même — vous pouvez patienter ou récupérer d'abord les journaux.",
    "stalledTitle": "AvA Code n'a pas pu terminer son démarrage",
  ...
  "tray": {
    ...
    "pinned": "Épinglées",
    "viewMore": "Voir plus…",
    "open": "Ouvrir AvA Code",
    "quit": "Quitter AvA Code",
    "askTitle": "Garder AvA Code en arrière-plan ?",
    "askBody": "Lorsque vous fermez la fenêtre, AvA Code peut continuer à s'exécuter dans la barre d'état système afin que rien ne soit perdu. Vous pouvez modifier cela à tout moment dans les paramètres.",
    "closeToTray": "Près du bac",
    "confirmQuitTitle": "Quitter AvA Code ?",
  ...
  "chat": {
    ...
    "placeholder": "Demandez à AvA Code de vous aider pour tout",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Stockée dans AvA Code et utilisée par l'environnement d'exécution. Le plugin ne la reçoit jamais.",
  ...
  "scheduled": {
    "description": "Exécutez des tâches récurrentes tant que AvA Code est ouvert.",
    ...
    "localTimeHint": "Utilise le fuseau horaire local. Gardez AvA Code ouvert ; les exécutions manquées sont ignorées. Les actions restreintes nécessitent une autorisation.",
...
"importConfirm": "Les extensions importées s’exécutent dans le processus de l’agent avec les mêmes droits que ses outils. Les compétences déclarées peuvent ajouter des instructions à l’agent et les dépendances déclarées sont installées avec npm (scripts d’installation désactivés). Continuer ?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Ajoute les fournisseurs définis par ce plugin à la liste des fournisseurs des Paramètres. Le plugin fournit le point de terminaison et les modèles ; votre clé API reste dans AvA Code.",
      "desktop.control": "Permet d'appeler le catalogue AvA Code contrôlé ; les opérations destructrices exigent toujours confirm=true et le bearer token MCP n'est pas exposé.",
      ...
      "keyboard.globalShortcut": "Enregistre des raccourcis clavier système qui déclenchent les commandes propres à ce plugin lorsque AvA Code n'est pas au premier plan.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Cette version de AvA Code est plus ancienne que vos données locales (schéma de données {{found}}, cette version prend en charge {{supported}}). Installez la version plus récente de AvA Code qui a ouvert ces données en dernier, ou une version ultérieure.",
    "archMismatch":
